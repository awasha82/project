  ...
  <main>
          <table id="tbl"     cellpadding="10">
              ...
              <tbody>
                ...
                for(var x = 1 ; x < tbl1.rows.length ; x++){

                    tbl1.rows[x].onclick = function(){
                        
                        document.getElementById("Id_nu").value = this.cells[0].innerHTML;
                        document.getElementById("M_F").value = this.cells[1].innerHTML;
                        document.getElementById("name_full1").value = this.cells[2].innerHTML;
                        document.getElementById("name_m").value = this.cells[3].innerHTML;
