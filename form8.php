...
<h3> رصد النتائج النهائية لإجتياز الدورة </h3>
 ...
 <!--   <section class="cards" id="services"> -->
    ...
    <form action="" method="POST">
               ...
               <br>
                   ...
                   <label> علوم قانونية </label>
                   <input type="text" name="name_full" value=""/>

                   <label> علـوم أمنيــة  </label>
                   <input type="text" name="name_full" value=""/><br><br>

                   <label> الأسلـحــــة </label>
                   <input type="text" name="name_full" value=""/>

                   <label>المـشـــــــاة </label>
                   <input type="text" name="name_full" value=""/><br><br>

                   <label>تربيـة بدنيــة </label>
                   <input type="text" name="name_full" value=""/>

                   <label> الـسـلــــــوك  </label>
                   <input type="text" name="name_full" value=""/><br><br>

                   <label> المجمــــــوع </label>
                   <input type="text" name="name_full" value=""/>

                   
                   <label> الـنتيجــــــة </label>
                   <input type="text" name="name_full" value=""/><br><br>

                   
                   <label> الـتقديــــــر </label>
                   <input type="text" name="name_full" value=""/>
